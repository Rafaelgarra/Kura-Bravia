...
var MEDIA_CATALOG = {
  ...
  animes: [
    { id: "jujutsu-kaisen", title: "Jujutsu Kaisen", year: "2020", rating: "9.3", genres: ["Action", "Fantasy"], backdrop: "https://images.unsplash.com/photo-1578632767115-351597cf2477?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4", nationality: "International" },
    { id: "demon-slayer", title: "Demon Slayer", year: "2019", rating: "9.5", genres: ["Action", "Adventure"], backdrop: "https://images.unsplash.com/photo-1612036782180-6f0b6cd846fe?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", nationality: "International" },
    { id: "solo-leveling", title: "Solo Leveling", year: "2024", rating: "9.6", genres: ["Action", "Adventure"], backdrop: "https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", nationality: "International" },
    { id: "cyber-moon", title: "Cyber Moon", year: "2025", rating: "8.8", genres: ["Sci-Fi", "Action"], backdrop: "https://images.unsplash.com/photo-1535223289827-42f1e9919769?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4", nationality: "Domestic" },
    { id: "cowboy-bebop", title: "Cowboy Bebop", year: "1998", rating: "9.7", genres: ["Action", "Sci-Fi"], backdrop: "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", nationality: "International" },
    { id: "astro-boy", title: "Astro Boy", year: "1963", rating: "8.5", genres: ["Sci-Fi", "Adventure"], backdrop: "https://images.unsplash.com/photo-1563089145-599997674d42?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", nationality: "International" }
  ],
  series: [
    { id: "dark-horizon", title: "Dark Horizon", year: "2022", rating: "9.0", genres: ["Sci-Fi", "Drama"], backdrop: "https://images.unsplash.com/photo-1519608487953-e999c86e7455?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", nationality: "Domestic" },
    { id: "neo-tokyo", title: "Neo Tokyo", year: "2023", rating: "9.1", genres: ["Sci-Fi", "Action"], backdrop: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", nationality: "International" },
    { id: "steampunk-chronicles", title: "Steampunk Chronicles", year: "2021", rating: "8.9", genres: ["Adventure", "Sci-Fi"], backdrop: "https://images.unsplash.com/photo-1478760329108-5c3ed9d495a0?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", nationality: "Domestic" },
    { id: "breaking-bad", title: "Breaking Bad", year: "2008", rating: "9.8", genres: ["Drama", "Action"], backdrop: "https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4", nationality: "International" }
  ],
  movies: [
    { id: "cyber-moon-movie", title: "Cyber Moon: The Movie", year: "2026", rating: "8.9", genres: ["Sci-Fi", "Action"], backdrop: "https://images.unsplash.com/photo-1535223289827-42f1e9919769?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutback.mp4", nationality: "Domestic" },
    { id: "neo-tokyo-hacker", title: "Neo Tokyo: Hacker", year: "2024", rating: "9.2", genres: ["Sci-Fi", "Drama"], backdrop: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4", nationality: "International" },
    { id: "cidade-de-deus", title: "City of God", year: "2002", rating: "9.7", genres: ["Drama", "Action"], backdrop: "https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?q=80&w=500&auto=format&fit=crop", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4", nationality: "Domestic" }
  ]
};
